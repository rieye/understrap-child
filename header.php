...
wp_nav_menu( array( 
    ...
    'container_class' => 'tools-menu',
    'depth' => 1 ) ); 
?>
<?php
wp_nav_menu( array( 
    'theme_location' => 'main-sections-menu', 
    'container_class' => 'main-sections-menu', 
    'depth' => 1 ) ); 
?>
		<nav class="navbar navbar-toggleable-md navbar-inverse bg-primary">
<?php
wp_nav_menu( array( 
    'theme_location' => 'children-or-siblings-menu', 
    'container_class' => 'children-or-siblings-menu',
    'depth' => 1 ) ); 
?>
